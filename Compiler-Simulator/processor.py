...
reg_bits = {'PC': 8, 'MIDR': 8, 'MDAR': 18, 'MDDR': 8, 'ART': 9, 'ARG': 9
        ...
        , 'AC': 12, 'K0': 8, 'K1': 8, 'G0': 8, 'G1': 8, 'G2': 8 
...
clocks       = {'TOGL': 2, 'LOAD': 2, 'LADD': 9, 
                'LODK' : 3, 'STAC': 2, 'JUMP' : 4, 'ADD': 2, 
                'INCR': 3,  'DECR': 3, 'DIV': 3, 'SUBT': 2, 
    ...
    while reg['PC'] < len(i_mem):
        ...
        if(debug_compiler):
            ...
            try:
                ...
                isError = True;
                print('Error at line: ', reg['PC'] + 1, i_mem[reg['PC']], i_mem[reg['PC']-1])
                break
